            ...
            <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
                ...
                <div class="footer-subscribe">
                    ...
                    <div class="d-inline-block">
                        @if ($value->ios_status == 'Yes')
                            <a class="btn btn-white btn-sm btn-app " href="{{ $value->ios_link }}">
                        ...
                        @endif
                        @if ($value->apk_status == 'Yes')
                            <a class="btn btn-white btn-sm btn-app mt-3" href="{{ $value->apk_link }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-right mt-4 mt-md-0">
                        <p class="mb-0"> &copy;Copyright <span id="copyright">
                            ...
                            </span> <a href="#"> Wize Job Portal </a> {{ __('menu.All Rights Reserved') }} </p>
                    </div>
                </div>
            </div>
        </div>
  ...
  Back To Top-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (lastSegment == 'en') {
                var modalurl = weblang + '/closesigninmodal';
            } else {
                var modalurl = 'closesigninmodal';
            }
